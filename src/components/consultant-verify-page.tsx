    ...
    <div className="min-h-screen bg-[color:var(--bg-canvas)] px-4 py-10 md:py-16">
      <div className="mx-auto w-full max-w-3xl">
        <header className="mb-8 flex flex-col items-center text-center">
          <div className="flex h-16 w-16 items-center justify-center rounded-md bg-ink text-white shadow-[0_10px_30px_rgba(17,24,39,0.18)]">
        ...
        <div className="rounded-md border border-black/5 bg-white/92 p-6 shadow-[0_24px_80px_rgba(17,24,39,0.08)] backdrop-blur sm:p-10">
          {report ? (
            <section className="mb-10">
              <div className="mb-4 flex items-center justify-between gap-4">
                ...
                <span className="inline-flex items-center gap-1.5 rounded-md bg-slate-100 px-3 py-1 text-xs font-medium text-slate-600">
                  <span className="h-1.5 w-1.5 rounded-md bg-slate-400" />
                  Called by {calledByPartyName}
                </span>
              </div>
              <div className="rounded-md border border-slate-200/80 bg-slate-50/60 p-6 text-base leading-7 text-slate-800 whitespace-pre-wrap sm:p-8">
                {report}
              </div>
            </section>
          ) : null}
          ...
          {reportFileUrl ? (
            <section className="mb-10">
              ...
              <a
                ...
                className="group flex items-center justify-between gap-4 rounded-md border border-slate-200 bg-white px-5 py-4 transition hover:-translate-y-0.5 hover:border-ink/20 hover:shadow-md"
              >
                <div className="flex items-center gap-4">
                  <div className="flex h-11 w-11 items-center justify-center rounded-md bg-slate-100 text-slate-600 transition group-hover:bg-ink group-hover:text-white">
          ...
          <section className="mb-10 rounded-md border border-amber-200/80 bg-amber-50 p-6 sm:p-7">
          ...
          <section className="mb-8">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="flex items-start gap-3 rounded-md border border-slate-200/70 bg-white p-4">
          ...
          <div className="flex flex-col items-center gap-3 border-t border-slate-200 pt-8">
            <button
              ...
              className="w-full max-w-sm rounded-md bg-ink px-6 py-4 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:bg-slate-800 disabled:opacity-60"
            >
